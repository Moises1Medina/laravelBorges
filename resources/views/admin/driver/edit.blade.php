            ...
            <div class="row">
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <br>
                        <h6 class="text-black text-capitalize ps-3">Editar driver: {{$driver->nombre}}</h6>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                {!! Form::model($driver,['route'=>['driver.update',$driver]
                                                        ,'method'=>'put']) !!}
                                    ...
                                    {!! Form::submit('Actualizar conductor',['class'=>'btn bg-gradient-primary']) !!}
